...
const PORTFOLIO: PortfolioItem[] = [
  ...
  },
  {
    ...
    label: "Skull FX",
    category: "sfx",
    description: "Dramatic skull prosthetic makeup",
  },
  {
    src: IMAGES.prosthetic.oldAge,
    label: "Aging Prosthetic",
    category: "prosthetic",
    description: "Realistic old-age prosthetic application",
  },
  {
    src: IMAGES.sfx.wound1,
    label: "Wound Effects",
    category: "sfx",
    description: "Film-grade wound SFX makeup",
  },
  {
  ...
  },
  {
    ...
    category: "prosthetic",
    description: "Custom eye prosthetic design",
  },
  {
    src: IMAGES.sfx.faceWounds,
    label: "Face SFX",
    category: "sfx",
    description: "Multi-wound face SFX for film",
  },
  {
    src: IMAGES.sfx.faceScar,
    label: "Scar Effect",
    category: "sfx",
    description: "Realistic scar tissue makeup",
  },
  {
  ...
  },
  {
    ...
    label: "T-Series: Dhora Mathe",
    category: "tseries",
    description: "Rajasthani T-Series music video",
  },
  {
  ...
  },
  {
    ...
    label: "T-Series: Saajan",
    category: "tseries",
    description: "T-Series music video look",
  },
  {
  ...
  },
  {
    ...
    category: "movie",
    description: "Celebrity collaboration with BM Vyas",
  },
  {
    src: IMAGES.movie.eightOClock,
    label: "Eight O Clock",
    category: "movie",
    description: "Short film — Makeup Credits: Shila Kashyap",
  },
  {
    src: IMAGES.facePainting,
    label: "Face Painting",
    category: "face",
    description: "Artistic face painting design",
  },
];
